...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3276462220523626329, ; hash 0x2d785507b64c5f59, from name: aot-ChessTrainerApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 9947693128807197381, ; hash 0x8a0d4e320d25aac5, from name: aot-ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 283
	...
	%struct.DSOCacheEntry {
		i64 10244626085857153801, ; hash 0x8e2c392590375309, from name: ChessTrainerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 13942574852539480858, ; hash 0xc17df9f51be8fb1a, from name: libaot-ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 412
	...
	%struct.DSOCacheEntry {
		i64 15885301225400835083, ; hash 0xdc73ed4cf2181c0b, from name: ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 465
	...
	%struct.DSOCacheEntry {
		i64 16331577197115131374, ; hash 0xe2a56aeeafeac5ee, from name: libaot-ChessTrainerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 479
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6441996a-5604-4b83-9907-c659009a7c59\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.chesstrainerapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-ChessTrainerApp.dll.so\00", align 16
...
@.DSOCacheEntry.63_name = private unnamed_addr constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 16
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 16
...
@.DSOCacheEntry.82_name = private unnamed_addr constant [46 x i8] c"libaot-System.Threading.Tasks.Parallel.dll.so\00", align 16
