...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 119, ; uint32_t number_of_assemblies_in_apk (0x77)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 538, ; uint32_t number_of_dso_cache_entries (0x21a)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 863289109, ; hash 0x3374bf15, from name: ChessTrainerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 95
	%struct.DSOCacheEntry {
		i64 869473018, ; hash 0x33d31afa, from name: aot-System.Threading.Tasks.Parallel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-System.Threading.Tasks.Parallel.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.63_name, ; name: libaot-System.Diagnostics.DiagnosticSource.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1929104016, ; hash 0x72fbca90, from name: aot-ChessTrainerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 222
	...
	%struct.DSOCacheEntry {
		i64 2613409584, ; hash 0x9bc57730, from name: libaot-ChessTrainerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 322
	...
	%struct.DSOCacheEntry {
		i64 3252060058, ; hash 0xc1d67f9a, from name: libaot-ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
	...
	%struct.DSOCacheEntry {
		i64 3485699531, ; hash 0xcfc38dcb, from name: ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
	%struct.DSOCacheEntry {
		i64 3487973540, ; hash 0xcfe640a4, from name: aot-ChessTrainerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessTrainerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [119 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6441996a-5604-4b83-9907-c659009a7c59\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.chesstrainerapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-ChessTrainerApp.dll.so\00", align 1
...
@.DSOCacheEntry.63_name = private unnamed_addr constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 1
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 1
...
@.DSOCacheEntry.82_name = private unnamed_addr constant [46 x i8] c"libaot-System.Threading.Tasks.Parallel.dll.so\00", align 1
